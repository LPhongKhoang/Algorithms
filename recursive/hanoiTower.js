...
function haNoiTowerSolving(n, colStart, col2, colEnd) {
  if(n==1) {
    console.log('Chuyen dia 1: ' + colStart + ' -> ' + colEnd );
    return;
  }

  haNoiTowerSolving(n-1, colStart, colEnd, col2); // n-1 dia da o cot "col2"

  console.log('Chuyen dia ' + n + ': ' + colStart + ' -> ' + colEnd); // dia to nhat o cot "ColEnd"

  haNoiTowerSolving(n-1, col2, colStart, colEnd); // n-1 dia da o cot "colEnd"
} 
